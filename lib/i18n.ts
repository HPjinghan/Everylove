...
'即将上线': 'Coming soon',
  ...
  // D-117～D-120：分享流 / 他正在看 / 勿扰时段
  '转给他': 'Give it to him',
  '转给谁': 'Give it to',
  '转给你': 'Sent to you',
  '转给 TA ›': 'Give it to them ›',
  '转过去了': 'Sent',
  '去交友': 'Go to Match',
  '通讯录里还没有人。': 'Nobody in your contacts yet.',
  '{name} 正在看你的手机': '{name} is looking at your phone',
  '{name} 放下了手机': '{name} put the phone down',
  ...
  '登录': 'Sign in',
  '日签': 'Daily Sign',
  '日签 · {luck}': 'Daily sign · {luck}',
  '零钱': 'Pocket money',
  '今天的运势': 'Today\'s fortune',
  '明天再来': 'Come back tomorrow',
  '看一眼': 'Take a look',
  '账单': 'Ledger',
  '零钱 {n}': 'Pocket money {n}',
  '给 {name} 的红包': 'Red packet for {name}',
  '她的红包': 'Her red packet',
  '零钱不够了': 'Not enough pocket money',
  '{name} 没拆的红包': 'Red packet {name} left unopened',
  '给她的红包': 'Red packet for her',
  '给她点的{item}': '{item} ordered for her',
  '你的{item}到了': 'Your {item} has arrived',
  '外卖': 'Delivery',
  '已送达': 'Delivered',
  '骑手已接单': 'Courier accepted',
  '骑手在路上 · 约 {n} 分钟': 'Courier on the way · about {n} min',
  '{name} 的红包': '{name}\'s red packet',
  '零钱 +{amount}': 'Pocket money +{amount}',
  '点开': 'Open',
  '大吉': 'Great luck',
  '吉': 'Good luck',
  '中吉': 'Fair luck',
  ...
  '退回': 'Refund',
  '钱包': 'Wallet',
  '今天说什么都会被接住。': 'Whatever you say today will be caught.',
  '想做的事，今天就是那一天。': 'The thing you want to do: today is the day.',
  '有人在很远的地方替你高兴。': 'Someone far away is happy for you.',
  '顺着走，别回头看。': 'Keep going, don\'t look back.',
  '今天适合把想说的话说出口。': 'A good day to say what you\'ve been meaning to.',
  '路上会捡到一点小好运。': 'You\'ll pick up a little luck on the way.',
  '平平的一天，也是好的一天。': 'An ordinary day is a good day too.',
  '不急，该来的在路上。': 'No rush. What\'s coming is on its way.',
  '今天适合早点睡。': 'A good day to sleep early.',
  '有点小波折，但都过得去。': 'A few bumps, but you\'ll get through.',
  '别把话憋着，说出来就轻了。': 'Don\'t hold it in. Saying it makes it lighter.',
  '今天喝口热的。': 'Have something warm today.',
  '慢一点，今天不适合赶。': 'Slow down. Today isn\'t for rushing.',
  '把今天当成休息日。': 'Treat today as a day off.',
  '明天会比今天好一点。': 'Tomorrow will be a little better than today.',
  '{name} 给你点的': 'Ordered for you by {name}',
  '下单': 'Order',
  '你给 {name} 点的': 'You ordered for {name}',
  '商家已接单': 'Order accepted',
  '点单': 'Menu',
  '给 {name} 点的{item}': '{item} for {name}',
  '给自己': 'For me',
  '给自己点的': 'For yourself',
  ...
  'Max 不限流量': 'Max has unlimited data',
  '{blurb} · 每回合 {n}': '{blurb} · {n} per turn',
  '买（模拟）': 'Buy (mock)',
  '今天免费的还剩 {n}': "{n} of today's free data left",
  '剩余流量': 'Data left',
  '已到账': 'Added',
  '流量包 {n}': 'Data pack {n}',
  '流量用完了': 'Out of data',
  ...
  '⑧ TA 的声音': '⑧ Their voice',
  '换一批': 'Show others',
  '这门语言的语音识别还没接上': 'Voice input is not available in this language yet',
  '今天也在想你。': 'Thought about you again today.',
  '温柔': 'Gentle',
  '低沉': 'Deep',
  '清冷': 'Cool',
  '少年感': 'Boyish',
  ...
  '人外': 'Otherworldly',
  // 角色更新通道（D-140）
  '换成作者的最新设定？': 'Switch to the creator’s latest version?',
  '聊天记录、记忆、等级都留着，只换设定、台词、世界与声音。换了不能退回。': 'Your chats, memories and level stay. Only the character’s lore, lines, world and voice change. This can’t be undone.',
  '换': 'Switch',
  '已换成最新设定': 'Updated to the latest version',
  '作者更新了 · 换成最新 ›': 'Creator updated · switch ›',
  '已是最新': 'Up to date',
  // __EN_END__
};
...
'即将上线': '近日公開',
  ...
  '转过去了': '送りました',
  '去交友': 'マッチへ',
  '通讯录里还没有人。': '連絡先にまだ誰もいません。',
  '{name} 正在看你的手机': '{name}があなたのスマホを見ています',
  '{name} 放下了手机': '{name}がスマホを置きました',
  'TA 主动找你': '相手からの連絡',
  '勿扰时段': 'おやすみ時間',
  ...
  '账单': '明細',
  '零钱 {n}': 'お小遣い {n}',
  '给 {name} 的红包': '{name}へのお年玉',
  '她的红包': '彼女からのお年玉',
  '零钱不够了': 'お小遣いが足りない',
  '{name} 没拆的红包': '{name}が開けなかったお年玉',
  '给她的红包': '彼女へのお年玉',
  '给她点的{item}': '彼女に頼んだ{item}',
  '你的{item}到了': '{item}が届いたよ',
  '外卖': 'デリバリー',
  '已送达': '配達済み',
  '骑手已接单': '配達員が受付',
  '骑手在路上 · 约 {n} 分钟': '配達中 · あと約 {n} 分',
  '{name} 的红包': '{name}からのお年玉',
  '零钱 +{amount}': 'お小遣い +{amount}',
  '点开': '開ける',
  '大吉': '大吉',
  '吉': '吉',
  '中吉': '中吉',
  ...
  '退回': '返金',
  '钱包': 'ウォレット',
  '今天说什么都会被接住。': '今日は何を言っても受け止めてもらえる。',
  '想做的事，今天就是那一天。': 'やりたかったこと、今日がその日。',
  '有人在很远的地方替你高兴。': '遠くで誰かがあなたのことを喜んでいる。',
  '顺着走，别回头看。': 'そのまま進んで、振り返らないで。',
  '今天适合把想说的话说出口。': '言いたかったことを口にするのにいい日。',
  '路上会捡到一点小好运。': '道すがら小さな幸運を拾える。',
  '平平的一天，也是好的一天。': '平らな一日も、いい一日。',
  '不急，该来的在路上。': '急がなくていい、来るものは向かっている。',
  '今天适合早点睡。': '今日は早めに眠るのにいい日。',
  '有点小波折，但都过得去。': '少しつまずくけど、全部越えられる。',
  '别把话憋着，说出来就轻了。': '溜め込まないで、言えば軽くなる。',
  '今天喝口热的。': '今日は温かいものをひと口。',
  '慢一点，今天不适合赶。': 'ゆっくり。今日は急ぐ日じゃない。',
  '把今天当成休息日。': '今日は休みの日だと思って。',
  '明天会比今天好一点。': '明日は今日より少しよくなる。',
  '{name} 给你点的': '{name}があなたに頼んだ',
  '下单': '注文する',
  '你给 {name} 点的': '{name}に頼んだ',
  '商家已接单': '店が受付',
  '点单': 'メニュー',
  '给 {name} 点的{item}': '{name}への{item}',
  '给自己': '自分に',
  '给自己点的': '自分に頼んだ',
  '给自己点的{item}': '自分に頼んだ{item}',
  '给谁点': '誰に届ける',
  '订单': '注文履歴',
  '这单没下成': 'この注文は通りませんでした',
  '骑手取餐中': '配達員が受け取り中',
  ...
  'Max 不限流量': 'Max はデータ無制限',
  '{blurb} · 每回合 {n}': '{blurb} · 1ターン {n}',
  '买（模拟）': '購入（模擬）',
  '今天免费的还剩 {n}': '今日の無料分 残り {n}',
  '剩余流量': '残りデータ',
  '已到账': '追加しました',
  '流量包 {n}': 'データパック {n}',
  '流量用完了': 'データを使い切りました',
  ...
  '⑧ TA 的声音': '⑧ あの人の声',
  '换一批': '他の声',
  '这门语言的语音识别还没接上': 'この言語の音声入力はまだ使えません',
  '今天也在想你。': '今日も、君のこと考えてた。',
  '温柔': 'やさしい',
  '低沉': '低音',
  '清冷': 'クール',
  ...
  '人外': '人外',
  // 角色更新通道（D-140）
  '换成作者的最新设定？': '作者の最新設定に切り替えますか？',
  '聊天记录、记忆、等级都留着，只换设定、台词、世界与声音。换了不能退回。': 'トーク・記憶・レベルはそのまま。設定・セリフ・世界・声だけが変わります。元には戻せません。',
  '换': '切り替える',
  '已换成最新设定': '最新の設定に切り替えました',
  '作者更新了 · 换成最新 ›': '作者が更新 · 最新にする ›',
  '已是最新': '最新です',
  // __JA_END__
};
...
const ko: Record<string, string> = {
  ...
  '转过去了': '보냈어요',
  '去交友': '매칭으로',
  '通讯录里还没有人。': '연락처에 아직 아무도 없어요.',
  '{name} 正在看你的手机': '{name}이(가) 내 휴대폰을 보고 있어요',
  '{name} 放下了手机': '{name}이(가) 휴대폰을 내려놓았어요',
  'TA 主动找你': '먼저 연락하기',
  '勿扰时段': '방해 금지 시간',
  ...
  '账单': '내역',
  '零钱 {n}': '용돈 {n}',
  '给 {name} 的红包': '{name}에게 준 세뱃돈',
  '她的红包': '그녀의 세뱃돈',
  '零钱不够了': '용돈이 부족해요',
  '{name} 没拆的红包': '{name}이(가) 열지 않은 세뱃돈',
  '给她的红包': '그녀에게 준 세뱃돈',
  '给她点的{item}': '그녀에게 시켜준 {item}',
  '你的{item}到了': '{item}이(가) 도착했어요',
  '外卖': '배달',
  '已送达': '배달 완료',
  '骑手已接单': '라이더 접수',
  '骑手在路上 · 约 {n} 分钟': '배달 중 · 약 {n}분',
  '{name} 的红包': '{name}의 세뱃돈',
  '零钱 +{amount}': '용돈 +{amount}',
  '点开': '열기',
  '大吉': '대길',
  ...
  '退回': '환불',
  '钱包': '지갑',
  '今天说什么都会被接住。': '오늘은 무슨 말을 해도 받아줄 거예요.',
  '想做的事，今天就是那一天。': '하고 싶던 일, 오늘이 그날이에요.',
  '有人在很远的地方替你高兴。': '멀리서 누군가 당신을 위해 기뻐하고 있어요.',
  '顺着走，别回头看。': '그대로 가요, 뒤돌아보지 말고.',
  '今天适合把想说的话说出口。': '하고 싶던 말을 꺼내기 좋은 날.',
  '路上会捡到一点小好运。': '가는 길에 작은 행운을 주울 거예요.',
  '平平的一天，也是好的一天。': '평범한 하루도 좋은 하루예요.',
  '不急，该来的在路上。': '서두르지 않아도 돼요, 올 것은 오고 있어요.',
  '今天适合早点睡。': '오늘은 일찍 자기 좋은 날.',
  '有点小波折，但都过得去。': '조금 삐걱거리지만 다 지나가요.',
  '别把话憋着，说出来就轻了。': '담아두지 말아요, 말하면 가벼워져요.',
  '今天喝口热的。': '오늘은 따뜻한 걸 한 모금.',
  '慢一点，今天不适合赶。': '천천히요, 오늘은 서두를 날이 아니에요.',
  '把今天当成休息日。': '오늘은 쉬는 날이라고 생각해요.',
  '明天会比今天好一点。': '내일은 오늘보다 조금 나을 거예요.',
  '{name} 给你点的': '{name}이(가) 시켜준',
  '下单': '주문하기',
  '你给 {name} 点的': '{name}에게 시킨',
  '商家已接单': '가게 접수 완료',
  '点单': '메뉴',
  '给 {name} 点的{item}': '{name}에게 시킨 {item}',
  '给自己': '나에게',
  '给自己点的': '나에게 시킨',
  '给自己点的{item}': '나에게 시킨 {item}',
  '给谁点': '누구에게',
  '订单': '주문 내역',
  '这单没下成': '이 주문은 실패했어요',
  '骑手取餐中': '라이더 픽업 중',
  ...
  'Max 不限流量': 'Max는 데이터 무제한',
  '{blurb} · 每回合 {n}': '{blurb} · 턴당 {n}',
  '买（模拟）': '구매(모의)',
  '今天免费的还剩 {n}': '오늘 무료분 {n} 남음',
  '剩余流量': '남은 데이터',
  '已到账': '충전됐어요',
  '流量包 {n}': '데이터 팩 {n}',
  '流量用完了': '데이터를 다 썼어요',
  ...
  '⑧ TA 的声音': '⑧ 그 사람의 목소리',
  '换一批': '다른 목소리',
  '这门语言的语音识别还没接上': '이 언어의 음성 입력은 아직 지원하지 않아요',
  '今天也在想你。': '오늘도 네 생각 했어.',
  '温柔': '다정한',
  '低沉': '중저음',
  '清冷': '차분한',
  ...
  '人外': '인외',
  // 角色更新通道（D-140）
  '换成作者的最新设定？': '작가의 최신 설정으로 바꿀까요?',
  '聊天记录、记忆、等级都留着，只换设定、台词、世界与声音。换了不能退回。': '대화·기억·레벨은 그대로예요. 설정·대사·세계·목소리만 바뀌고, 되돌릴 수 없어요.',
  '换': '바꾸기',
  '已换成最新设定': '최신 설정으로 바꿨어요',
  '作者更新了 · 换成最新 ›': '작가가 업데이트함 · 최신으로 ›',
  '已是最新': '최신이에요',
  // __KO_END__
};
